...
const NuevoPassword = () => {
  ...
  const handleSubmit = async e => {
    ...
    if (password.length < 6 ) {
      setAlerta({
        msg: "El password debe ser minimo de  caracteres",
        error: true
      })
      return
    }
  ...
  return (
    <>
      ...
      {passwordModificada && ( <Link className='block text-center my-5 text-slate-500 uppercase text-sm' to="/">Inicia Sesion</Link>)}      
    </>    
  )
}
